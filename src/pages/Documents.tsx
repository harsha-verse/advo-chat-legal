...
const Documents: React.FC = () => {
  ...
  const documents = [
    {
      id: 1,
      title: 'Rental Agreement - Mumbai Flat',
      type: 'Agreement',
      category: 'Property',
    ...
    {
      id: 3,
      title: 'Power of Attorney - Property Sale',
      type: 'Legal Document',
      category: 'Personal',
      ...
      size: '156 KB',
      lawyerReviewed: true,
      reviewedBy: 'Adv. Rajesh Kumar'
    },
    {
      id: 4,
      title: 'NDA - Business Partnership',
      type: 'Agreement',
      category: 'Business',
  ...
  const filters = [
    ...
    { id: 'review_pending', name: 'Pending Review' },
  ...
  const getStatusText = (status: string) => {
    switch (status) {
      ...
      case 'review_pending': return 'Pending Review';
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-muted-foreground">
            Manage your legal documents, templates, and contracts.
          </p>
        </div>
      ...
      <Card className="bg-primary/5 border-primary/10">
        <CardContent className="p-6">
          <h3 className="font-semibold text-lg mb-4">Need help with your documents?</h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <Button variant="outline" className="flex items-center space-x-2">
              <Eye className="h-4 w-4" />
              <span>Get Document Reviewed</span>
            </Button>
            <Button variant="outline" className="flex items-center space-x-2">
